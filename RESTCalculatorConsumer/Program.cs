...
namespace RESTCalculatorConsumer
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(Async(d, "Add"));
            
            Data d2 = new Data(7, 5);
            Console.WriteLine(Async(d2, "Subtract"));

            Data d3 = new Data(20, 4);
            Console.WriteLine(Async(d3, "Multiply"));

            Data d4 = new Data(30, 3);
            Console.WriteLine(Async(d4, "Divide"));

            Console.ReadLine();
        }

        public static string Async(Data data, string calculationType)
        {
            using (HttpClient client = new HttpClient())
            {
                ...
                HttpResponseMessage response = client.PostAsync(CalculatorUri + calculationType, content).Result;
